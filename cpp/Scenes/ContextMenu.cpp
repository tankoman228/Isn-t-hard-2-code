		...
		for (int i = 0; i < 6; i++) {
			...
			if (cursor.getGlobalBounds().intersects(box_but.getGlobalBounds())) {
				...
				if (Mouse::isButtonPressed(Mouse::Left)) {
					...
					case 3: InitGameSceneLevel(lvlnum); context_menu = false; break;
					case 4: checkpoint(); context_menu = false; ChangeScene("menu"); break;
					case 5: context_menu = false; ChangeScene("menu"); break;
					}
				}
			}
			...
			switch (i) {
				...
				case 3: text.setString("Try again"); break;
